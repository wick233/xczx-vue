<template>
  <div class="step-body">
    ...
    <div class="bar">
      ...
      <el-button size="medium" plain class="el-button" @click="handleAddChapter"
        >+添加章</el-button
      >
    </div>
    ...
    <div class="outline">
      <el-tree
        ...
        :default-expanded-keys="
          outlineData.teachPlanTreeNodes.map((item) => item.teachPlanId)
        "
      >
        <!-- 自定义行 -->
        <template slot-scope="{ node, data }">
          ...
          >
            ...
            <div class="operate">
              ...
              <div
                class="submit-time"
                v-if="data.grade == '2' && teachmode == '200003'"
              >
              ...
              <div class="media-file" v-if="data.grade == '2'">
                <el-link
                  v-if="
                    data.teachplanMedia != null &&
                    data.teachplanMedia.mediaFilename != null &&
              ...
              <div class="buttons" v-if="data.grade == '1'">
                <el-button
                  type="text"
                  @click.stop="
                    handleAddSection(data.teachPlanTreeNodes, data.id)
                  "
                  >添加小节</el-button
                >
                <el-button
                ...
                >
                <!-- 上移 -->
                <el-button type="text" @click.stop="moveUP(data.id)"
                  >上移</el-button
                >
                <!-- 下移 -->
                <el-button type="text" @click.stop="moveDown(data.id)"
                  >下移</el-button
                >
              </div>
              ...
              <div class="buttons" v-else-if="data.grade == '2'">
                <template v-if="teachmode == '200002'">
                  ...
                  <!-- 视频 -->
                  <el-button type="text" @click.stop="handleSelectVideo(data)"
                    >添加视频</el-button
                  >
                ...
                <!-- 删除 -->
                <el-button type="text" @click.stop="handleDeleteNode(data.id)"
                  >删除</el-button
                >
                <!-- 上移 -->
                <el-button type="text" @click.stop="moveUP(data.id)"
